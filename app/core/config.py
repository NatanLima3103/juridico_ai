...
FREE_PLAN_DAILY_GENERATION_LIMIT = int(
    os.getenv("FREE_PLAN_DAILY_GENERATION_LIMIT", os.getenv("FREE_PLAN_MONTHLY_GENERATION_LIMIT", "10"))
)
PRO_PLAN_MONTHLY_GENERATION_LIMIT = int(os.getenv("PRO_PLAN_MONTHLY_GENERATION_LIMIT", "1000"))
FREE_PLAN_WRITING_PROFILE_LIMIT = int(os.getenv("FREE_PLAN_WRITING_PROFILE_LIMIT", "5"))
PRO_PLAN_WRITING_PROFILE_LIMIT = int(os.getenv("PRO_PLAN_WRITING_PROFILE_LIMIT", "25"))
PAYMENT_PROVIDER = os.getenv("PAYMENT_PROVIDER", "manual").strip().lower() or "manual"
